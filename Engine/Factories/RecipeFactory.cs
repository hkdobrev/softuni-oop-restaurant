namespace RestaurantManager.Engine.Factories
{
    ...
    public class RecipeFactory : IRecipeFactory
    {
        ...
        {
            MainCourseType typeEnumerated = (MainCourseType) Enum.Parse(typeof(MainCourseType), type);
            return new MainCourse(name, price, calories, quantityPerServing, timeToPrepare, isVegan, typeEnumerated);
        }
